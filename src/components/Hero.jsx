    ...
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white px-4">
        <div className="text-center space-y-4 max-w-5xl mx-auto">
          {/* Main headline */}
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-black leading-none tracking-tight animate-fade-in-up delay-200" style={{ letterSpacing: '-0.02em' }}>
            <span style={{ color: '#FF6B00' }}>FA</span><span className="text-white">MU</span>
            {' '}
            <span className="text-white/90">AJANS</span>
          </h1>
